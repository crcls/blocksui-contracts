...
const func: DeployFunction = async function (hre: HardhatRuntimeEnvironment) {
  const Contract = await hre.ethers.getContractFactory('BUIOriginRegistry')
...
func.tags = ['BUIOriginRegistry']
func.skip = async () => {
  return !['all', 'BUIOriginRegistry'].includes(process.env.CONTRACT)
}
